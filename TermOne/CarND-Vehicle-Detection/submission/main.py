...
if __name__ == "__main__":
    ...
    with open('image.p', 'wb') as handle:
        pickle.dump(window_img, handle, protocol=pickle.HIGHEST_PROTOCOL)
    ...
    mpimg.imsave("out1.png", out_img)

    ## Heat Map
    with open('image.p', 'rb') as handle:
        box_list = pickle.load(handle)
    ...
    mpimg.imsave("heatmap.png", heatmap)
